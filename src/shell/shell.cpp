...
//		"\xBA DOSBox runs real and protected mode games.                         \xBA\n"
	...
	if (!mono_cga) {
		...
		MSG_Add("SHELL_STARTUP_CGA","\xBA Use \033[31mF11\033[37m to cycle through green, amber, white and paper-white mode, \xBA\n"
		        "\xBA and \033[31mAlt-F11\033[37m to change contrast/brightness settings.                \xBA\n"
		);
	}
	MSG_Add("SHELL_STARTUP_HERC","\xBA Use \033[31mF11\033[37m to cycle through white, amber, paper-white and green mode. \xBA\n"
	        "\xBA                                                                    \xBA\n"
	);
